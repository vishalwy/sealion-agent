...
"${script_base_dir}/../code/bin/jsonfig" -a "set" -k "" -v "{$config}" -n "${script_base_dir}/../code/etc/agent.json"  #set the configuration
...
[[ "$config" != "" ]] && "${script_base_dir}/../code/bin/jsonfig" -a "add" -k "env" -v "[$config]" "${script_base_dir}/../code/etc/config.json"

#update config.json with logging level
"${script_base_dir}/../code/bin/jsonfig" -a "set" -k "logging:level" -v "\"debug\"" "${script_base_dir}/../code/etc/config.json"
