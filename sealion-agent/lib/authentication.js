...
function reAuth() {
    if(attemptNumber >= (options.reconnectInterval.length - 1)) {
...
function sendAuthRequest() {
    ...
    try{
        ...
        agentDetails.agentVersion = agentConfig.agentVersion;
...
function authenticate() {
    /*
     ...
     use that array.
     If max connection attempts reached then try making connection again after
